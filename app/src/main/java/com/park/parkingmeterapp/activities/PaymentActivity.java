...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("Url", "http://54.162.93.65/services/ekashu/index.php?auth_token=" + ParkApp.preferences.getAuthToken()+ "&mobile=android" + "&fname=" + ParkApp.preferences.getUSER_FNAME() + "&lname=" + ParkApp.preferences.getUSER_lNAME() + "&address=" + ParkApp.preferences.getUSER_ADDRESS1() + "&city=" + ParkApp.preferences.getUSER_CITY() + "&zone_id=" + ParkApp.preferences.getUSER_STATE() + "&zip=" + ParkApp.preferences.getUSER_ZIP() + "&country_id=" + ParkApp.preferences.getUSER_COUNTRY() + "&email=" + ParkApp.preferences.getUSER_EMAIL()
...
//                + "&longitude=" + strLongitude + "&latitude=" + strlatitude + "&area=" + strArea + "&post=" + strPost + "&total_time=" + strTime + "" + "&amount=" + strAmount + "");
        webView.loadUrl("http://54.162.93.65/services/ekashu/index.php?auth_token=" + ParkApp.preferences.getAuthToken()+ "&mobile=android" + "&fname=" + ParkApp.preferences.getUSER_FNAME() + "&lname=" + ParkApp.preferences.getUSER_lNAME() + "&address=" + ParkApp.preferences.getUSER_ADDRESS1() + "&city=" + ParkApp.preferences.getUSER_CITY() + "&zone_id=" + ParkApp.preferences.getUSER_STATE() + "&zip=" + ParkApp.preferences.getUSER_ZIP() + "&country_id=" + ParkApp.preferences.getUSER_COUNTRY() + "&email=" + ParkApp.preferences.getUSER_EMAIL()
                + "&longitude=" + strLongitude + "&latitude=" + strlatitude + "&area=" + strArea + "&post=" + strPost + "&total_time=" + strTime + "" + "&amount=" + strAmount + "&selected_date=" + sdate + "&selected_time=" + stime );
